	...
	return (
		<>
			{reports.length != 0 && (
				<Row>
					<Col xl={6}>
						<div className='text-center'>Biểu đồ thể hiện tổng số lượng sản phẩm bán được</div>
					...
					<Col xl={6}>
						<div className='text-center'>Biểu đồ thể hiện tổng thành tiền bán của từng sản phẩm </div>
