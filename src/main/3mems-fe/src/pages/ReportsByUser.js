	...
	return (
		<>
			{reports.length != 0 && (
				<Row>
					<Col xl={6}>
						<div className='text-center'>Biểu đồ thể hiện tổng số đơn hàng từng khách hàng đã thanh toán</div>
					...
					<Col xl={6}>
						<div className='text-center'>Biểu đồ thể hiện tổng thành tiền từng khách hàng đã thanh toán</div>
